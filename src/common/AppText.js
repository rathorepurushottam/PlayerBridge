...
export const MONTSERRAT_REGULAR = 'MONTSERRAT_REGULAR';
export const MONTSERRAT_LIGHT = 'MONTSERRAT_LIGHT';
export const MONTSERRAT_ITALIC = 'MONTSERRAT_ITALIC';
export const MONTSERRAT_MEDIUM = "MONTSERRAT_MEDIUM";
export const MONTSERRAT_SEMI_BOLD = 'MONTSERRAT_SEMI_BOLD';
export const MONTSERRAT_BOLD = 'MONTSERRAT_BOLD';
...
const getTextStyle = (
  ...
  switch (weight) {
    ...
    case MONTSERRAT_ITALIC:
      style['fontFamily'] = montserratItalic;
      break;
